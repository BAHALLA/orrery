...
Mock all external dependencies — no test should require running infrastructure. See [CONTRIBUTING.md](../CONTRIBUTING.md#testing-guidelines) for testing conventions.
